...
public class SentimentAnalysis {
	public static class BusinessMap extends Mapper<LongWritable, Text, Text, IntWritable> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			try {
				String sCurrentLine;
				positiveWordsBufferedReader = new BufferedReader(new FileReader("/Users/Soorya/positive-words.txt"));
			...
			try {
				String sCurrentLine;
				negativeWordsBufferedReader = new BufferedReader(new FileReader("/Users/Soorya/negative-words.txt"));
